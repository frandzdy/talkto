 ...
 */
final class Version20220205133642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD interest_gender SMALLINT NOT NULL, DROP notification, CHANGE has_notification_match has_notification_match TINYINT(1) NOT NULL');
    }
