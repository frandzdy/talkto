 ...
 */
final class Version20220205131232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE has_notification_match has_notification_match SMALLINT DEFAULT 1 NOT NULL');
    }
