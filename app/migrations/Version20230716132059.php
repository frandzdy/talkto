 ...
 */
final class Version20230716132059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, reservation_id INT DEFAULT NULL, author_id INT DEFAULT NULL, message LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, token VARCHAR(255) NOT NULL, INDEX IDX_B6BD307FB83297E7 (reservation_id), INDEX IDX_B6BD307FF675F31B (author_id), INDEX ecommerce_message (author_id, created_at, reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, status SMALLINT NOT NULL, reference VARCHAR(20) DEFAULT NULL, payment_intent_id VARCHAR(40) DEFAULT NULL, total_amount_ttc INT NOT NULL, total_amount_tva INT NOT NULL, total_fees INT NOT NULL, token VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_723705D1F675F31B (author_id), INDEX ecommerce_transaction (author_id, created_at, token, status), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, country_id INT DEFAULT NULL, picture_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, genre SMALLINT NOT NULL, city VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, additional_address VARCHAR(255) DEFAULT NULL, zip_code VARCHAR(5) NOT NULL, phone VARCHAR(20) NOT NULL, description LONGTEXT DEFAULT NULL, password VARCHAR(255) NOT NULL, lat VARCHAR(15) DEFAULT NULL, lon VARCHAR(15) DEFAULT NULL, stripe_customer_id VARCHAR(40) DEFAULT NULL, stripe_account_id VARCHAR(40) DEFAULT NULL, is_stripe_account_active TINYINT(1) NOT NULL, is_guess TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, token VARCHAR(255) NOT NULL, intro_menu TINYINT(1) DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649F92F3E70 (country_id), UNIQUE INDEX UNIQ_8D93D649EE45BDBF (picture_id), INDEX ecommerce_user (email, firstname, lastname, created_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE wishlist (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, user_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, token VARCHAR(255) NOT NULL, INDEX IDX_9CE12A314584665A (product_id), INDEX IDX_9CE12A31A76ED395 (user_id), INDEX ecommerce_wishlists (product_id, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
