 ...
 */
final class Version20220206233436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD hide_account24 TINYINT(1) DEFAULT NULL, ADD hide_account_date24 DATETIME DEFAULT NULL');
    }
